...
*/
        ...
        var face = new THREE.Face3(offset, offset + 1, offset + 2);


        var vnorm1 = new THREE.Vector3(xn1, yn1, zn1);
        var vnorm2 = new THREE.Vector3(xn2, yn2, zn2);
        face.vertexNormals.push(vnorm1.clone(), vnorm2.clone(), vnorm2.clone());
        face.materialIndex = 0;

        scope.faces.push(face);
        face = new THREE.Face3(offset , offset + 2, offset + 3);
        face.vertexNormals.push(vnorm1.clone(), vnorm2.clone(), vnorm2.clone());
        face.materialIndex = 0;
